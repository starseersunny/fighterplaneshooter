...
public class GameManager : MonoBehaviour
{
    ...
    void CreateEnemyR()
    {
        Instantiate(enemyRPrefab, new Vector3(Random.Range(-horizontalScreenSize, horizontalScreenSize) *
        0.9f, verticalScreenSize, 0), Quaternion.Euler(180, 0, 0));
    }
    ...
    void CreateEnemyK()
    {
        Instantiate(enemyKPrefab, new Vector3(Random.Range(-horizontalScreenSize, horizontalScreenSize) *
        0.9f, verticalScreenSize, 0), Quaternion.Euler(180, 0, 0));
    }
